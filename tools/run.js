...
function spawnServer() {
    ...
    return cp.spawn(
        ...
        [
            ...
            // !!! exclude vue-strap because it caused window = undefined problem due to
            //     it works only front-end
            ...Object.keys(pkg.dependencies)
                .filter(pkgName => !blacklistPkg.includes(pkgName))
                .reduce(
            ...
            ...(isDebug
                ...
                : [
                    '--eval',
                    'process.stdin.on("data", data => { if (data.toString() === "load") ' +
                    'require("./server.js"); });',
                ]),
        ],
